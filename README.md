...
- Langkah Ketiga
```
screen -S setup-session bash -c "wget -q https://raw.githubusercontent.com/Nizwarax/nix/main/setup.sh && chmod +x setup.sh && ./setup.sh; read -p 'Tekan enter untuk keluar...'"
```
...
## UPDATE
```
wget https://raw.githubusercontent.com/Nizwarax/nix/main/update.sh && chmod +x update.sh && ./update.sh
```
